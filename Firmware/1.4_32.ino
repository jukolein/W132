...
#define LED 2  //at ESP32_dev_kit, LED is at pin 2
...
void loop() {
  ...
  int Z = fmod((convertRawAngleToDegrees(ams5600.getRawAngle()) + offset.toInt() + 360), 360); //stores the value of the angle mod 360
